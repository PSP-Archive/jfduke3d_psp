...
struct player_struct
{
    ...
    unsigned char  holster_weapon,falling_counter;
...
extern unsigned char music_fn[4][11][13],music_select;
extern unsigned char env_music_fn[4][13];
...
extern unsigned char networkmode;
